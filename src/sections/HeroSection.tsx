    ...
    <section className="hero-section hero-v5">
      ...
      >
        ...
        <p className="hero-subtitle">
          {t('The first open-source Agent Cognitive Topology Engine', '首个开源 Agent 认知拓扑引擎')}
        </p>
        ...
        <div className="hero-actions">
          <a href="https://stello-agent.github.io/docs" target="_blank" rel="noopener noreferrer" className="hero-btn hero-btn--primary">
            {t('Get Started', '快速开始')} →
          </a>
          <a
        ...
        <div className="hero-v5-cards">
          {heroCards.map((card, i) => {
            ...
            return (
              ...
              >
                <h3 className="hero-v5-card-title">{t(card.title.en, card.title.zh)}</h3>
                <p className="hero-v5-card-content">{t(card.content.en, card.content.zh)}</p>
                <p
