...
export const BRAINSTORM_BI_NODES: BilingualDagNode[] = [
  ...
  {
    id: 'market',
    label: { en: 'Market Research', zh: '市场调研' },
    x: 155,
    y: 95,
    r: 42,
    color: '#cc88ff',
  ...
  {
    id: 'team',
    label: { en: 'Team Building', zh: '团队搭建' },
    x: 605,
    y: 385,
    r: 42,
    color: '#cc88ff',
  ...
  {
    id: 'interviews',
    label: { en: 'User Interviews', zh: '用户访谈' },
    x: 42,
    y: 38,
    r: 28,
    color: '#4488ff',
  ...
  {
    id: 'competitor',
    label: { en: 'Competitor Analysis', zh: '竞品分析' },
    x: 155,
    y: 18,
    r: 28,
    color: '#4488ff',
  ...
  {
    id: 'industry',
    label: { en: 'Industry Reports', zh: '行业报告' },
    x: 278,
    y: 38,
    r: 28,
    color: '#4488ff',
  ...
  {
    id: 'investors',
    label: { en: 'Investor Profiles', zh: '投资人画像' },
    x: 38,
    y: 440,
    r: 28,
    color: '#4488ff',
  ...
  {
    id: 'valuation',
    label: { en: 'Valuation Model', zh: '估值逻辑' },
    x: 278,
    y: 440,
    r: 28,
    color: '#4488ff',
  ...
  {
    id: 'cofounder',
    label: { en: 'Co-founder Search', zh: '联创寻找' },
    x: 482,
    y: 458,
    r: 28,
    color: '#4488ff',
  ...
  {
    id: 'equity',
    label: { en: 'Equity Structure', zh: '股权分配' },
    x: 605,
    y: 462,
    r: 28,
    color: '#4488ff',
...
export const USE_CASES_BI_NODES: BilingualDagNode[] = [
  ...
  {
    id: 'tech',
    label: { en: 'Tech Architecture', zh: '技术方案' },
    x: 115,
    y: 85,
    r: 42,
    color: '#cc88ff',
  ...
  {
    id: 'legal',
    label: { en: 'Legal & Compliance', zh: '法律合规' },
    x: 645,
    y: 85,
    r: 42,
    color: '#cc88ff',
  ...
  {
    id: 'invest',
    label: { en: 'Investment Research', zh: '投资研究' },
    x: 100,
    y: 390,
    r: 42,
    color: '#cc88ff',
  ...
  {
    id: 'learning',
    label: { en: 'Learning & Growth', zh: '学习成长' },
    x: 660,
    y: 390,
    r: 42,
    color: '#cc88ff',
  ...
  {
    id: 'sysdesign',
    label: { en: 'System Design', zh: '架构设计' },
    x: 22,
    y: 32,
    r: 26,
    color: '#4488ff',
  ...
  {
    id: 'schools',
    label: { en: 'School Selection', zh: '选校策略' },
    x: 288,
    y: 12,
    r: 26,
    color: '#4488ff',
  ...
  {
    id: 'contracts',
    label: { en: 'Contract Review', zh: '合同审查' },
    x: 638,
    y: 15,
    r: 26,
    color: '#4488ff',
  ...
  {
    id: 'ip',
    label: { en: 'IP Protection', zh: '知识产权' },
    x: 735,
    y: 42,
    r: 26,
    color: '#4488ff',
  ...
  {
    id: 'sector',
    label: { en: 'Sector Analysis', zh: '行业分析' },
    x: 18,
    y: 348,
    r: 26,
    color: '#4488ff',
  ...
  {
    id: 'diligence',
    label: { en: 'Due Diligence', zh: '标的调研' },
    x: 85,
    y: 455,
    r: 26,
    color: '#4488ff',
  ...
  {
    id: 'knowledge',
    label: { en: 'Knowledge Map', zh: '知识体系' },
    x: 652,
    y: 455,
    r: 26,
    color: '#4488ff',
